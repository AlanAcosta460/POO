...
public class EquipoRojo extends Thread {
    static volatile int progreso = 0;

    public EquipoRojo(ThreadGroup g, String nombre) {
        super(g, nombre);
    }
    ...
    public synchronized void correr(Thread a, int i) {
        ...
        System.out.println("Atleta Rojo " + (i+1) + " empieza");

        try {
            Thread.sleep(rand.nextInt(10000) + 2001);
        } catch(InterruptedException e) {}

        System.out.println("Atleta Rojo " + (i+1) + " pasa la estafeta");
    }
}
